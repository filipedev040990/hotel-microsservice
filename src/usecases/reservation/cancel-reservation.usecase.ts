import {
  ReservartionRepositoryInterface,
  ReservationRepositoryData,
...
import {
  ...
  CancelReservationUseCaseInterface,
} from "@/domain/usecases/reservation/cancel-reservation-usecase.interface";
import { AppContainer } from "@/infra/container/register";
import {
  HOTELS_CACHE_KEY,
  PAYMENT_STATUS,
  RESERVATION_CANCELED_BY_CLINET,
  RESERVATION_STATUS,
  ROOM_STATUS,
...
export class CancelReservationUseCase
  implements CancelReservationUseCaseInterface
{
  ...
  ): Promise<ReservationRepositoryData> {
